      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '60px' }}>
          <div className="card" style={{ backgroundColor: '#FFFFFF', padding: '28px' }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '10px', backgroundColor: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', color: '#2563EB' }}>
              <Award size={22} />
            </div>
            ...
            {mockMentors.map((m) => (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.8125rem', color: '#2563EB', fontWeight: 600, marginBottom: '6px' }}>
                    {m.title}
                  </div>
